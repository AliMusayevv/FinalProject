...
<div class="buy-sin-single">
			<div class="col-sm-5 middle-side immediate">
				         ...
				         <p><span class="bath5">Rent Price: </span><asp:Label ID="LblRentPrice" runat="server" class="all lol" Text="Label"></asp:Label></p>
				<p><span class="bath2">Phone:</span>:<asp:Label ID="LblPhone" runat="server" class="two lol " Text="Label"></asp:Label></p>
