...
<div class="login-right">
	<div class="container">
		...
		<div class="login-top">
				...
				<div class="form-info">
					<form runat="server">
						<asp:TextBox ID="TxtLogUsername" placeholder="Username" runat="server"></asp:TextBox>      
						<asp:TextBox ID="TxtLogPassword" placeholder="Password" type="password" runat="server"></asp:TextBox>     
